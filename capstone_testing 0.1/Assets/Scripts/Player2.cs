...
public class Player2 : MonoBehaviour {
    ...
    Animator animator;
	Controller2DP2 controller;
    SpriteRenderer sprite;

	void Start() {
		controller = GetComponent<Controller2DP2> ();
	...
	void Update() {
		...
		Vector2 input = new Vector2 (Input.GetAxisRaw ("P2Horizontal"), Input.GetAxisRaw ("P2Vertical"));
        if (input.x != 0)
        {
        ...
        if (Input.GetKeyDown (KeyCode.UpArrow) && (controller.collisions.below ||  maxjumps > 0)) {
